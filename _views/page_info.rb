      ...
      div(
        ...
        div(class: "hidden gap-2 group-data-[page-info-has-data-value=true]:flex") do
          ...
          div(class: "min-w-0 grow") do
            h1(
              data: { page_info_target: "title" },
              class: "text-700 mb-1 line-clamp-3 font-bold empty:hidden"
            )
            p(
              data: { page_info_target: "description" },
              class: "mb-1 line-clamp-3 empty:hidden"
            )
            p(
              data: { page_info_target: "url" },
              class: "text-500 mb-1 truncate empty:hidden"
            )
          end
        end
      end
