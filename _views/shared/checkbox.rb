module Views
  module Shared
    class Checkbox < Jekyll::Component
      ...
      def view_template
        css = "
          active:bg-200 flex h-[16px] w-[16px] appearance-none shrink-0 items-center justify-center rounded border border-input shadow-sm
          outline-2 outline-offset-1 outline-transparent transition
          before:block before:h-[7px] before:w-[9px] before:bg-transparent before:content-['']
